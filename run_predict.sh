...
nice -n 10 python3 -W ignore $DIR/main.py --project ardi_eurchf_sell --predict_module standard --main_model xgb --pred_data_prep ardi --tp 0.0025 --sl 0.01 --period 240 --nb_tree_features 50&
