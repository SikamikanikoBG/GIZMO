...
nice -n 10 python3 -W ignore $DIR/main.py --project ardi_eurcad_sell --predict_module standard --main_model xgb --pred_data_prep ardi  --tp 0.0025 --sl 0.015 --period 480 --nb_tree_features 15&
...
nice -n 10 python3 -W ignore $DIR/main.py --project ardi_gbpaud_sell --predict_module standard --main_model xgb --pred_data_prep ardi  --tp 0.0025 --sl 0.015 --period 480 --nb_tree_features 15&
